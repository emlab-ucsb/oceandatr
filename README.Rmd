...
seamounts <- get_seamounts_buffered(spatial_grid = bermuda_grid, buffer = 30000)
...
enviro_regions <- get_enviro_regions(spatial_grid = bermuda_grid, num_clusters = 3)
```
