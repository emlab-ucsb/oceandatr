...
```{r area_of_interest, fig.height=h, fig.width=w, out.width=ow}
...
```{r bermuda-grid, warning=FALSE, fig.height=h, fig.width=w, out.width=ow}
...
```{r grid_cells, fig.height=h, fig.width=w, out.width=ow}
...
```{r depth_classification, fig.height=h, fig.width=w, out.width=ow}
...
```{r coral_habitat, warning=FALSE, message=FALSE, fig.height=h, fig.width=w, out.width=ow}
...
```{r environmental_regions, warning=FALSE, message=FALSE, fig.height=h, fig.width=w, out.width=ow}
...
```{r enviro_regions_maps, warning=FALSE, message=FALSE, fig.height=h, fig.width=w, out.width=ow}
