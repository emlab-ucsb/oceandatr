test_that("returns bermuda example - sf", {
  expect_s3_class(suppressWarnings(get_seamounts_buffered(area_polygon = get_area(area_name = "Bermuda"), 
...
test_that("returns bermuda example - raster", {
  expect_s4_class(suppressWarnings(get_seamounts_buffered(planning_grid = get_planning_grid(area_polygon = get_area(area_name = "Bermuda"), 
