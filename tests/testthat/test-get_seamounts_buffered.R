...
test_that("returns bermuda example - raster", {
  expect_s4_class(suppressWarnings(get_seamounts_buffered(spatial_grid = get_grid(area_polygon = get_area(area_name = "Bermuda", mregions_column = "territory1"), 
...
test_that("returns kiribati example - raster", {
  expect_s4_class(suppressWarnings(get_seamounts_buffered(spatial_grid = get_grid(area_polygon = get_area(area_name = "KIR", mregions_column = "iso_ter1"), 
