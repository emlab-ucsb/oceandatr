...
test_that("return correct object for Bermuda - raster", {
  expect_s4_class(get_geomorphology(spatial_grid = get_grid(area_polygon = get_area(area_name = "Bermuda", mregions_column = "territory1"), 
...
test_that("return correct object for Kiribati - sf", {
  expect_s3_class(get_geomorphology(area_polygon = get_area(area_name = "KIR", mregions_column = "iso_ter1")), 
                  class = "sf")
})

# Test failed
test_that("return correct object for Kiribati - raster", {
  expect_s4_class(get_geomorphology(spatial_grid = get_grid(get_area(area_name = "KIR", mregions_column = "iso_ter1"), 
