test_that("returns gridded Bermuda data - raster", {
  expect_s4_class(suppressWarnings(get_dist_shore(spatial_grid = get_grid(boundary = get_boundary(name = "Bermuda"), 
...
test_that("returns gridded data for Kiribati - sf", {
  expect_s3_class(suppressWarnings(get_dist_shore(spatial_grid = get_grid(boundary = get_boundary(name = "Kiribati", country_type = "sovereign"), 
