test_that("returns bermuda example", {
  expect_type(suppressWarnings(get_features(area_polygon = get_area(area_name = "Bermuda"))), 
                  type = "list")
})
...
test_that("returns bermuda example - gridded", {
  expect_s4_class(suppressWarnings(get_features(planning_grid = get_planning_grid(area_polygon = get_area(area_name = "Bermuda"), 
...
test_that("returns kiribati example - gridded", {
  expect_s4_class(suppressWarnings(get_features(planning_grid = get_planning_grid(area_polygon = get_area(area_name = "KIR", mregions_column = "iso_ter1"), 
