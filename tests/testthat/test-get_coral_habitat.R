...
test_that("returns coral habitat layer with 3 species - bermuda gridded", {
  expect_s4_class(get_coral_habitat(planning_grid = get_planning_grid(area_polygon = get_area(area_name = "Bermuda", mregions_column = "territory1"), 
...
test_that("returns coral habitat layer with 3 species - kiribati gridded", {
  expect_s4_class(get_coral_habitat(planning_grid = get_planning_grid(area_polygon = get_area(area_name = "KIR", mregions_column = "iso_ter1"), 
