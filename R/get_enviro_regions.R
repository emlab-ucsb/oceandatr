...
#'
#' @description This function gets [Bio-Oracle](https://bio-oracle.org/)  environmental data for the area of interest or planning grid and creates environmental regions using a clustering algorithm. Details are described in Magris et al. [2020](https://doi.org/10.1111/ddi.13183)
#' 
