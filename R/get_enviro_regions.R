...
get_enviro_regions <- function(area_polygon = NULL,  spatial_grid = NULL, raw_data = FALSE, show_plots = TRUE, num_clusters = NULL, max_num_clusters = 6, antimeridian = NULL, sample_size = 5000, num_samples = 5, num_cores = 1, custom_seed = 1234){
  ...
  enviro_data <- get_enviro_data(area_polygon = area_polygon, spatial_grid = spatial_grid, antimeridian = antimeridian)
