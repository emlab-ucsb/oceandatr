...
#' bermuda_coral_gridded <- get_coral_habitat(spatial_grid = planning_grid)
get_coral_habitat <- function(area_polygon = NULL, spatial_grid = NULL, antipatharia_threshold = 22, octocoral_threshold = 2, antimeridian = NULL){
  ...
  antipatharia <- get_data_in_grid(area_polygon = area_polygon, spatial_grid = spatial_grid, dat = antipatharia_global, name = "antipatharia", meth = meth, antimeridian = antimeridian)
