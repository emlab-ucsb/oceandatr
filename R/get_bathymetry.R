...
#' 
#' @details Extracts bathymetry data for an `area_polygon`, or if a `planning_grid` is supplied, gridded bathymetry is returned. 
#' 
...
#' @param planning_grid a rasteror sf planning grid with the desired resolution and coordinate reference system generated by `get_planning_grid()`. For a raster, values in the planning grid cells should be 1, while all other values are NA
...
#' @param name `string`; name of bathymetry raster or column in sf object
...
#'
#' @return A raster of bathymetry within the `area_polygon` if this was supplied, , rasterized to the planning grid resolution and CRS if supplied.
#' @export
#'
#' @examples
#' # Grab EEZ data first 
