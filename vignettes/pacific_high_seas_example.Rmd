...
pacific_hs_planning_grid_ras_lowres <- get_planning_grid(area_polygon = pacific_hs,
                                   projection_crs = pacific_hs_projection,
                                   resolution = 30000) 

pacific_hs_planning_grid_sf_lowres <- get_planning_grid(area_polygon = pacific_hs,
                                   projection_crs = pacific_hs_projection,
                                   option = "sf_hex",
                                   resolution = 30000)
