...
pacific_hs_planning_grid_ras_lowres <- get_grid(area_polygon = pacific_hs,
                                   projection_crs = pacific_hs_projection,
                                   resolution = 30000) 

pacific_hs_planning_grid_sf_lowres <- get_grid(area_polygon = pacific_hs,
                                   projection_crs = pacific_hs_projection,
                                   option = "sf_hex",
                                   resolution = 30000)
...
tmap::tm_shape(setNames(feature_set, gsub("_", " ", names(feature_set)) %>% stringr::str_to_sentence())) +
  tmap::tm_raster(palette = "forestgreen", legend.show = FALSE) +
...
```{r fishing-effort, fig.cap="Map of total apparent fishing effort in 2022 for the Pacific High Seas area. Data from Global Fishing Watch"}
