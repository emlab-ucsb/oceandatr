...
```{r pacific_high_sea_maps, message=FALSE, fig.cap="Map of Pacific High Seas planning region in regional context"}
...
```{r message=FALSE, fig.cap="Map of all features in the planning regions"}
...
```{r prioritization, fig.cap="Prioritization solution for the Pacific High Seas area."}
