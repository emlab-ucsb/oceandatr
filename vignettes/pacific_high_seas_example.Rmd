...
(case_study_map <- tmap::tm_shape(pacific_bathy*-1) +
  tmap::tm_raster(col.scale = tmap::tm_scale_continuous(values = "brewer.yl_gn_bu"),
                  col.legend = tmap::tm_legend(title = "Depth (m)",
                                               position = tmap::tm_pos_out("right"))) +
   tmap::tm_shape(eezs %>% sf::st_cast(to = "MULTILINESTRING")) +
  tmap::tm_lines(col = "name",
...
tmap::tmap_save(case_study_map, "case_study_map.png")
```
