...
```{r proceed with oceandatr setup, fig.align= "center", fig.cap="Planning grid of the Indonesian and Australian EEZs."}
...
```
```{r proceed with oceandatr data, fig.align= "center", fig.cap="Seamounts within the Indonesian and Australian EEZs."}
# Get seamount locations with a 30 km buffer
seamounts <- get_seamounts_buffered(planning_grid = planning_grid, 
                                    buffer = 30000)
# Plot seamount data
